export const it = {
  ...
  profile: {
    ...
    facts: {
      heading: 'Informazioni chiave',
      caption: 'Informazioni sul mio profilo professionale',
      factHeader: 'Voce',
      detailHeader: 'Dettaglio',
      role: {
        label: 'Ruolo',
        value: 'CTO e Product Engineer',
      },
      leadership: {
        label: 'Leadership',
        value:
          'CTO di due aziende software attive nello sviluppo mobile e nei sistemi di integrazione',
      },
      focus: {
        label: 'Focus',
        value: 'Piattaforme, applicazioni mobile, product engineering e workflow assistiti dall’AI',
      },
      stack: {
        label: 'Stack principale',
        value: 'Vue, TypeScript, Tailwind CSS, Supabase, Expo e strumenti AI moderni',
      },
      location: {
        label: 'Base',
        value: 'Udine, Italia, con un trasferimento in Giappone pianificato',
      },
      languages: {
        label: 'Lingue del sito',
        value: 'Inglese, italiano, giapponese, russo e ucraino',
      },
    },
    faqHeading: 'Domande sul mio lavoro',
    faq: {
      role: {
