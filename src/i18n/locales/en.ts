export const en = {
  ...
  profile: {
    ...
    facts: {
      heading: 'Key facts',
      caption: 'Facts about my professional profile',
      factHeader: 'Fact',
      detailHeader: 'Detail',
      role: {
        label: 'Role',
        value: 'CTO and Product Engineer',
      },
      leadership: {
        label: 'Leadership',
        value: 'CTO of two software companies in mobile development and systems integration',
      },
      focus: {
        label: 'Focus',
        value: 'Platforms, mobile applications, product engineering, and AI-assisted workflows',
      },
      stack: {
        label: 'Core stack',
        value: 'Vue, TypeScript, Tailwind CSS, Supabase, Expo, and modern AI tooling',
      },
      location: {
        label: 'Based in',
        value: 'Udine, Italy, with a planned move to Japan',
      },
      languages: {
        label: 'Site languages',
        value: 'English, Italian, Japanese, Russian, and Ukrainian',
      },
    },
    faqHeading: 'Questions about my work',
    faq: {
      role: {
